from __archive.__widget import Widget, ImageWidget, TextWidget
...
class Weather(Widget):
    ...
    async def update(self):
        ...
        self.current_data = await WeatherData.fetch_current()
        self.hourly_data = await WeatherData.fetch_current(False)
